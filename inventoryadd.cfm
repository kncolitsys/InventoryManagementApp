...
<html>
  ...
  <head>
    <title>CFInventory - New Inventory</title>
  ...
  <body>
	...
	<div class="container" style="padding-top: 25px;">
      ...
      <div class="row">
        <div class="col-lg-4">
          <p class="text-center" id="formInstructions" data-original="Fill in the fields below to add a new inventory item.">Fill in the fields below to add a new inventory item.</p>
          <div class="well well-sm">
            ...
            <button class="btn btn-block btn-info" onclick="inventoryNS.saveNewInventory();"><span class="glyphicon glyphicon-floppy-disk" style="padding-right: 10px;"></span> Save</button>
          </div>
        </div>
      </div>
      <!-- /container -->
