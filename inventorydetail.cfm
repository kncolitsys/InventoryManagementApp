...
<html>
   ...
   <head>
    <title>CFInventory - Inventory Detail</title>
	    ...
	    <script id="inventory-detail-template" type="text/x-handlebars-template">	   
	    	<div style="padding-left: 10px; padding-right: 10px;"> 
				<div class="well row" style="margin-top: -7px;" data-displayed-id="{{records.0.id}}">
					<div class="row" style="padding: 5px 0;">
						<div class="col-xs-4">
							<span class="pull-right"><b>Name</b>:</span>
						</div>
						<div class="col-xs-8">{{records.0.name}}</div>
					</div>
					<div class="row" style="padding: 5px 0;">
						<div class="col-xs-4">
							<span class="pull-right"><b>Supplier</b>:</span>
						</div>
						<div class="col-xs-8">{{records.0.suppliername}}</div>
					</div>
					<div class="row" style="padding: 5px 0;">
						<div class="col-xs-4">
							<span class="pull-right"><b>Location</b>:</span>
						</div>
						<div class="col-xs-8">{{records.0.locationname}}</div>
					</div>
					<div class="row" style="padding: 5px 0;">
						<div class="col-xs-4">
							<span class="pull-right"><b>Status</b>:</span>
						</div>
						<div class="col-xs-8">{{records.0.statusname}}</div>
					</div>
					<div class="row" style="padding: 5px 0;">
						<div class="col-xs-4">
							<span class="pull-right"><b>Onhand</b>:</span>
						</div>
						<div class="col-xs-8">{{records.0.onhand}}</div>
					</div>
					<div class="row" style="padding: 5px 0;">
						<div class="col-xs-4">
							<span class="pull-right"><b>Threshold</b>:</span>
						</div>
						<div class="col-xs-8">{{records.0.threshold}}</div>
					</div>
					<div class="row" style="padding: 5px 0;">
						<div class="col-xs-4">
							<span class="pull-right"><b>Cost</b>:</span>
						</div>
						<div class="col-xs-8">{{records.0.cost}}</div>
					</div>
					<div class="row" style="padding: 5px 0;">
						<div class="col-xs-4">
							<span class="pull-right"><b>Retail</b>:</span>
						</div>
						<div class="col-xs-8">{{records.0.retail}}</div>
					</div>
					<div class="row" style="padding: 5px 0;">
						<div class="col-xs-4">
							<span class="pull-right"><b>Serail Num</b>:</span>
						</div>
						<div class="col-xs-8">{{records.0.serialnum}}</div>
					</div>
					<div class="row" style="padding: 5px 0;">
						<div class="col-xs-4">
							<span class="pull-right"><b>Description</b>:</span>
						</div>
						<div class="col-xs-8">{{records.0.description}}</div>
					</div>
		    	</div>	
		    	<div class="row" style="text-align: center;">
			    	<div class="media">
						{{#if records.0.photo}}
							<img class="media-object" src="data:image/jpeg;base64,{{records.0.photo}}" style="max-width:100%; max-height:auto;">
						{{else}}
			...
			<div>
				...
				<div class="col-xs-4">
					<button type="button" class="btn btn-danger btn-lg btn-block" onclick="inventoryNS.deleteInventory({{records.0.id}})"><span class="glyphicon glyphicon-trash"></span></button>
				</div>
				<div class="col-xs-4">
					<a type="button" class="btn btn-success btn-lg btn-block" href="./inventoryedit.cfm?i={{records.0.id}}"><span class="glyphicon glyphicon-pencil"></span></a>
				</div>
			</div>
	    </script>
